...
namespace chimi
{
void CmGeometryUtil::CreateCube(float leftPlane, float rightPlane, float bottomPlane, float topPlane, float nearPlane, float farPlane,
                                    std::vector<CmVertex> &vertices, std::vector<uint32_t> &indices, const bool bUseTextcoords,
