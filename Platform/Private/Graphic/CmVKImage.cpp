...
namespace chimi
{
    CmVKImage::CmVKImage(CmVKDevice *device, VkExtent3D extent, VkFormat format, VkImageUsageFlags usage, VkSampleCountFlagBits sampleCount) : mDevice(device),
                                                                                                            mExtent(extent),
                                                                                                            mFormat(format),
                                                                                                            mUsage(usage) {
    ...
    void CmVKImage::CopyFromBuffer(VkCommandBuffer cmdBuffer, CmVKBuffer *buffer) {
    ...
    bool CmVKImage::TransitionLayout(VkCommandBuffer cmdBuffer, VkImage image, VkImageLayout oldLayout, VkImageLayout newLayout) {
