...
protected:
    ...
    void OnInit() override {
        ...
        mPipelineLayout = std::make_shared<chimi::CmVKPipelineLayout>(device, CHIMI_SHADER_OUTPUT_DIR"/01_hello_buffer.vert", CHIMI_SHADER_OUTPUT_DIR"/01_hello_buffer.frag", shaderLayout);
