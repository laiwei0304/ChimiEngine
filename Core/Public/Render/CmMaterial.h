...
// -------------------------------------------------------------------------------------------------
    ...
    class CmMaterial{
    public:
        CmMaterial(const CmMaterial&) = delete;
        CmMaterial &operator=(const CmMaterial&) = delete;
        ...
        void SetTextureView(uint32_t id, CmTexture *texture, CmSampler *sampler);
    ...
    class CmMaterialFactory{
    public:
        CmMaterialFactory(const CmMaterialFactory&) = delete;
        CmMaterialFactory &operator=(const CmMaterialFactory&) = delete;

        static CmMaterialFactory* GetInstance(){
    ...
    private:
        CmMaterialFactory() = default;

        static CmMaterialFactory s_MaterialFactory;

        std::unordered_map<uint32_t, std::vector<std::shared_ptr<CmMaterial>>> mMaterials;
    };
}
